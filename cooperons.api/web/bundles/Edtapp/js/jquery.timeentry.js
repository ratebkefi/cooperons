...
function TimeEntry() {
	...
	this._defaults = {
		...
		defaultTime: '00h15', // The time to use if none has been set, leave at null for now
		minTime: '00h15', // The earliest selectable time, or null for no limit
		maxTime: '13h00', // The latest selectable time, or null for no limit
	...
	_handleKeyPress: function(inst, chr) {
		if (chr == inst.options.separator) {
			...
			var hour = (inst._field != 0 ? inst._selectedHour :
				(inst.options.show24Hours ? (value < 100 ? value : key) :
