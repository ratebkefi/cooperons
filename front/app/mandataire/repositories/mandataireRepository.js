/**
 * @ngdoc service
 * @name mandataire.services:mandataireRepository
 * @description
 * This file defines the mandataireRepository
 */
define([], function () {
    'use strict';
    mandataireRepository.$inject = ["$q", 'Restangular'];
 
    function mandataireRepository($q, Restangular) {
        return {
            ...
            * @ngdoc method
            * @name getMandataire
            * @methodOf mandataire.services:mandataireRepository
            * @description
