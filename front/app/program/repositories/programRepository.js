/**
 * @ngdoc service
 * @name program.services:programRepository
 * @description
 * This file defines the programRepository
 */
define([], function () {
    'use strict';
    programRepository.$inject = ["$q", 'Restangular'];
    
    function programRepository($q, Restangular) {
        return {
            ...
            * @ngdoc method
            * @name getPrograms
            * @methodOf program.services:programRepository
            * @description
            * Get all programs 
            * 
