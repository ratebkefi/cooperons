...
.directive('rzslider', ['Slider', function(Slider)
{
  return {
    ...
    template:   '<span class="bar EnableSliderToggle"></span>' + // 0 The slider bar
                ...
                '<span class="" style="display:none"></span>' + // 9 Range label when the slider handles are close ex. 15 - 17
